...
BRAND_ALIASES = {
    ...
    "nintendo": ["#nintendo"],
    "ps5": ["#ps5", "#playstation5", "#playstation"],
    "ps4": ["#ps4", "#playstation4", "#playstation"],
    "xbox series": ["#xboxseries", "#xbox", "#microsoft"],
    "gameboy": ["#gameboy", "#nintendo", "#retrogaming"],
    "game boy": ["#gameboy", "#nintendo", "#retrogaming"],
    "switch oled": ["#switcholed", "#nintendo", "#nintendoswitch"],
    "naruto": ["#naruto", "#narutoshipudden"],
    "attack on titan": ["#attackontitan", "#snk", "#shingekinokyojin"],
    "demon slayer": ["#demonslayer", "#kimetsu"],
    "jujutsu": ["#jujutsunoyoru", "#jujutsukaisen"],
    "hunter x hunter": ["#hunterxhunter", "#hxh"],
    "bleach": ["#bleach", "#tybw"],
    "vinland saga": ["#vinlandsaga"],
    "berserk": ["#berserk"],
    "chainsaw man": ["#chainsawman"],
    "my hero academia": ["#myheroaccademia", "#mha", "#boku"],
...
UNIVERSE_TAGS = {
    ...
    "console": ["#console", "#gaming", "#jeuvidéo", "#retrogaming"],
    "manga": ["#manga", "#anime", "#otaku", "#mangacollection"],
}
...
FALLBACK_CONSOLE_TAGS = [
    "#console", "#gaming", "#jeuvidéo", "#gamer", "#retrogaming",
    "#manette", "#controller", "#videogames", "#collector",
    "#nintendo", "#playstation", "#xbox", "#nostalgie",
]

FALLBACK_MANGA_TAGS = [
    "#manga", "#anime", "#otaku", "#mangacollection", "#mangavf",
    "#shonen", "#shojo", "#seinen", "#collector", "#japanculture",
]

# Manga title → specific hashtags (title slug + characters + abbreviations)
# Used in a dedicated pipeline when article_type == "manga"
MANGA_TITLE_ALIASES = {
    "one piece": ["#onepiece", "#op", "#luffy", "#mugiwara", "#eiichirooda"],
    "naruto": ["#naruto", "#uzumaki", "#konoha", "#sasuke"],
    "naruto shippuden": ["#naruto", "#shippuden", "#uzumaki", "#konoha"],
    "dragon ball": ["#dragonball", "#dbz", "#goku", "#saiyan", "#vegeta"],
    "dragon ball z": ["#dragonball", "#dbz", "#goku", "#saiyan"],
    "dragon ball super": ["#dragonball", "#dbs", "#goku", "#saiyan"],
    "attack on titan": ["#attackontitan", "#aot", "#snk", "#eren", "#levi"],
    "shingeki no kyojin": ["#attackontitan", "#aot", "#snk", "#eren"],
    "demon slayer": ["#demonslayer", "#kny", "#tanjiro", "#nezuko"],
    "kimetsu no yaiba": ["#demonslayer", "#kny", "#tanjiro"],
    "jujutsu kaisen": ["#jujutsukaisen", "#jjk", "#gojo", "#itadori"],
    "jujutsu": ["#jujutsukaisen", "#jjk", "#gojo"],
    "bleach": ["#bleach", "#ichigo", "#tybw", "#zanpakuto", "#kurosaki"],
    "hunter x hunter": ["#hunterxhunter", "#hxh", "#gon", "#killua"],
    "fullmetal alchemist": ["#fullmetalalchemist", "#fma", "#edward", "#elric"],
    "fma": ["#fullmetalalchemist", "#fma", "#elric"],
    "death note": ["#deathnote", "#light", "#ryuk", "#dn", "#kira"],
    "my hero academia": ["#myheroaccademia", "#mha", "#bnha", "#deku", "#bakugo"],
    "boku no hero": ["#myheroaccademia", "#mha", "#bnha", "#deku"],
    "chainsaw man": ["#chainsawman", "#csm", "#denji", "#pochita", "#makima"],
    "tokyo ghoul": ["#tokyoghoul", "#tg", "#kaneki", "#ghoul"],
    "vinland saga": ["#vinlandsaga", "#thorfinn", "#askeladd"],
    "berserk": ["#berserk", "#guts", "#griffith", "#miura"],
    "fairy tail": ["#fairytail", "#ft", "#natsu", "#erza", "#lucy"],
    "sword art online": ["#swordartonline", "#sao", "#kirito", "#asuna"],
    "black clover": ["#blackclover", "#asta", "#yuno"],
    "boruto": ["#boruto", "#nextgenerations", "#naruto"],
    "one punch man": ["#onepunchman", "#opm", "#saitama", "#genos"],
    "spy x family": ["#spyxfamily", "#loid", "#anya", "#yor"],
    "tokyo revengers": ["#tokyorevengers", "#tr", "#mikey", "#takemichi"],
    "blue lock": ["#bluelock", "#isagi", "#bachira", "#football"],
    "haikyuu": ["#haikyuu", "#hinata", "#kageyama", "#volleyball"],
    "slam dunk": ["#slamdunk", "#sakuragi", "#rukawa", "#basketball"],
    "vagabond": ["#vagabond", "#musashi", "#inoue"],
    "akira": ["#akira", "#tetsuo", "#kaneda", "#cyberpunk"],
    "evangelion": ["#evangelion", "#nge", "#shinji", "#rei", "#asuka"],
    "monster": ["#monster", "#urasawa", "#tenma"],
    "20th century boys": ["#20thcenturyboys", "#urasawa"],
    "pluto": ["#pluto", "#urasawa", "#astroboy"],
    "kingdom": ["#kingdom", "#shinki", "#qin"],
    "initial d": ["#initiald", "#takumi", "#ae86", "#tofu"],
    "baki": ["#baki", "#bakihanma", "#ogre"],
    "detective conan": ["#detectiveconan", "#conan", "#shinichi", "#heiji"],
    "dr stone": ["#drstone", "#senku", "#tsukasa"],
    "promised neverland": ["#promisedneverland", "#tpn", "#emma", "#ray"],
    "solo leveling": ["#sololeveling", "#sunginjoo", "#shadow"],
    "tower of god": ["#towerofgod", "#tog", "#bam"],
    "black butler": ["#blackbutler", "#kuroshitsuji", "#sebastian", "#ciel"],
    "mob psycho": ["#mobpsycho", "#mob100", "#reigen"],
    "inuyasha": ["#inuyasha", "#kagome", "#kikyo"],
    "rurouni kenshin": ["#rurounikenshin", "#kenshin", "#samurai"],
    "shaman king": ["#shamanking", "#yoh", "#hao"],
    "ranma": ["#ranma12", "#ranma", "#rumikotakahashi"],
    "goodnight punpun": ["#punpun", "#goodnightpunpun", "#inio"],
    "oyasumi punpun": ["#punpun", "#goodnightpunpun"],
    "solanin": ["#solanin", "#inio", "#inioanno"],
    "nausicaa": ["#nausicaa", "#miyazaki", "#ghibli"],
    "cowboy bebop": ["#cowboybebop", "#spike", "#bebop"],
}
