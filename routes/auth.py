...
from helpers import login_required, build_credentials_from_account

logger = logging.getLogger(__name__)

auth_bp = Blueprint("auth", __name__)

# Re-export for backwards compat (other modules may import from here)
_build_credentials_from_account = build_credentials_from_account
